@echo off
"C:\\Program Files\\Unity\\Hub\\Editor\\2023.2.20f1\\Editor\\Data\\PlaybackEngines\\AndroidPlayer\\OpenJDK\\bin\\java" ^
  --class-path ^
  ...
  23 ^
  --output ^
  "D:\\School Work\\Github Repository\\ARVR-MCO\\ARVR MCO\\.utmp\\RelWithDebInfo\\3h5l283x\\prefab\\arm64-v8a\\prefab-configure" ^
